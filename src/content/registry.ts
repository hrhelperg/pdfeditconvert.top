...
import { GUIDES_ID } from "@/content/id/guides";
import { COMPARE_ID } from "@/content/id/compare";
import { USE_CASES_ID } from "@/content/id/use-cases";
import { HUBS_ID } from "@/content/id/hubs";
import { TOOL_CONTENT_ID } from "@/content/id/tools";
import { GUIDES_JA } from "@/content/ja/guides";
import { COMPARE_JA } from "@/content/ja/compare";
import { USE_CASES_JA } from "@/content/ja/use-cases";
import { HUBS_JA } from "@/content/ja/hubs";
import { TOOL_CONTENT_JA } from "@/content/ja/tools";
import { GUIDES_TR } from "@/content/tr/guides";
import { COMPARE_TR } from "@/content/tr/compare";
import { USE_CASES_TR } from "@/content/tr/use-cases";
import { HUBS_TR } from "@/content/tr/hubs";
import { TOOL_CONTENT_TR } from "@/content/tr/tools";
...
const CONTENT: Partial<Record<Locale, LocaleContent>> = {
  ...
  ja: {
    guides: GUIDES_JA,
    hubs: HUBS_JA,
    tools: TOOL_CONTENT_JA,
    compare: COMPARE_JA,
    useCases: USE_CASES_JA,
  },
  tr: {
    guides: GUIDES_TR,
    hubs: HUBS_TR,
    tools: TOOL_CONTENT_TR,
    compare: COMPARE_TR,
    useCases: USE_CASES_TR,
  },
};
